...
class Tests(unittest.TestCase):
    ...
    def test_1_dft_matrix(self):
        ...
        print(dft_matrix(4))
        print((dft_matrix(4).dot(dft_matrix(4).conjugate())))
    ...
    def test_2_is_unitary(self):
        ...
        bla = Tests.data["t2_m2"]
        #print("bla")
        #print(bla)
        ##print("bla conjugate")
        #print(bla.conjugate())
        #print("bla*conj")
        #print(bla.conjugate().transpose()*bla)
    ...
    def test_5_fft(self):
        ...
        print('-----------------------')
        print('-----------------------')
        print(np.fft.fft(data)/np.sqrt(data.size))
        print('-----------------------')
        print(fft(data))
    ...
    def test_6_generate_tone(self):
        ...
        print("printing arrays 0 - 3")
        print(mid_c[1000:1003]," - " ,Tests.data["t6_midc"][1000:1003])
